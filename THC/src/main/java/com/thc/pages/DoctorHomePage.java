...
public class DoctorHomePage extends TestBase {
	...
	//PageFactory - Object Repository : 
			@FindBy(xpath="//h3[@class='title']//i[@class='icon-info-sign']")WebElement doctorDashBoard;	
			@FindBy(xpath="//a[@href='#'][contains(text(),'doctor panel ')]")WebElement doctorPanel ;
			@FindBy(xpath="//a[@href='http://hms.esy.es/index.php?doctor/manage_patient']//i[@class='icon-user']")WebElement patient;
			@FindBy(xpath="//a[@href='#list']")WebElement patientName;
			@FindBy(xpath="//a[@href='http://hms.esy.es/index.php?doctor/manage_appointment']//i[@class='icon-exchange']")WebElement appointment;
			@FindBy(xpath="//a[@href='#list']")WebElement appointmentList;
			@FindBy(xpath="//a[@href='http://hms.esy.es/index.php?doctor/manage_prescription']//i[@class='icon-stethoscope']")WebElement prescription;
